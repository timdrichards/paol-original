...
int main(int argc, char** argv)
{
  ...
  newImg->read("img2.jpg","img2.jpg", 2, 2);
  ...
  WriteMod writer(buffer2);
  Module passMod(testBuffer, buffer2, 150);
  ReadMod patternReader(testBuffer);
  
  
  patternReader.ReadFromPattern(argv[1], argv[2]);
  testBuffer->print();
  passMod.nullRun();
  writer.WriteMats();
